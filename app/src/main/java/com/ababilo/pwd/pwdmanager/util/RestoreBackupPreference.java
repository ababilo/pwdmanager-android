...
public class RestoreBackupPreference extends Preference {

    private Context context;

    public RestoreBackupPreference(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    @Override
    public void onClick() {
        ((SettingsActivity) context).onRestoreBackupClick();
    }
}
